    ...
    .then(function (product_id) {
      ...
      return knex('images').insert([
        ...
        { product_id: product_id[3],
          path_1: '/images/tables/4_plate/1.png',
          path_2: '/images/tables/4_plate/2.png',
          path_3: '/images/tables/4_plate/3.png',
          path_4: '/images/tables/4_plate/4.png'
        },
        { product_id: product_id[4],
          path_1: '/images/tables/5_bondt/1.png',
          path_2: '/images/tables/5_bondt/2.png',
          path_3: '/images/tables/5_bondt/3.png',
          path_4: '/images/tables/5_bondt/4.png'
        },
        { product_id: product_id[5],
          path_1: '/images/tables/6_desalto/1.png',
          path_2: '/images/tables/6_desalto/2.png',
          path_3: '/images/tables/6_desalto/3.png',
          path_4: '/images/tables/6_desalto/4.png'
        },
        { product_id: product_id[6],
          path_1: '/images/lighting/7_kaiser/1.png',
          path_2: '/images/lighting/7_kaiser/2.png',
          path_3: '/images/lighting/7_kaiser/3.png',
          path_4: '/images/lighting/7_kaiser/4.png'
        },
        { product_id: product_id[7],
          path_1: '/images/lighting/8_melampo/1.png',
          path_2: '/images/lighting/8_melampo/2.png',
          path_3: '/images/lighting/8_melampo/3.png',
          path_4: '/images/lighting/8_melampo/4.png'
        },
      ]);
    });
  });
